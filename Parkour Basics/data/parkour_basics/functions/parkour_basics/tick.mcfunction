...
execute as @a[scores={placed_netherite_block=1}] at @s anchored eyes run function parkour_basics:parkour_basics/raycasting/end_pos_raycasting/start_ray
execute as @a[scores={placed_emerald_block=1}] at @s anchored eyes run function parkour_basics:parkour_basics/raycasting/start_pos_raycasting/start_ray
