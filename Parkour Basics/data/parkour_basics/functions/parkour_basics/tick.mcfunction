...
# Apply effects
execute if score #speedAdmin MapData matches 1 run effect give @p[scores={admin=1}] speed 1000000 0 true
execute if score #speedAdmin MapData matches 2 run effect give @p[scores={admin=1}] speed 1000000 1 true
execute if score #speedAdmin MapData matches 3 run effect give @p[scores={admin=1}] speed 1000000 2 true

execute if score #speedPlayers MapData matches 1 run effect give @p speed 1000000 0 true
execute if score #speedPlayers MapData matches 2 run effect give @p speed 1000000 1 true
execute if score #speedPlayers MapData matches 3 run effect give @p speed 1000000 2 true